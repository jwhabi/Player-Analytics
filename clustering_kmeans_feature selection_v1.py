...
train_new1 = train_new[['defensive_work_rate','preferred_foot','attacking_work_rate','gk_diving','gk_reflexes','gk_handling', 'gk_positioning', 'standing_tackle']].copy()
train_new1.shape

test_new1 = test_new[['defensive_work_rate','preferred_foot','attacking_work_rate','gk_diving','gk_reflexes','gk_handling', 'gk_positioning', 'standing_tackle']].copy()
test_new1.shape
...
test['predicted5'] =np.where((test['kmeans_2vars']==1), 10,test['kmeans_2vars'])
...
print(accuracy_score(test.predicted5,test.position2))#66.5
print(precision_score(test.predicted5,test.position2,average=None)) #[ 0.9971831   0.85457988  0.33770268  0.82216463]
print(recall_score(test.predicted5,test.position2,average=None)) #[ 0.99508082  0.6307979   0.60722071  0.66487026]
print(f1_score(test.predicted5,test.position2,average=None)) #[ 0.99613085  0.72583177  0.43402473  0.73519837]
